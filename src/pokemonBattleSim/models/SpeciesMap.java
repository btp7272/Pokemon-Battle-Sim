...
public class SpeciesMap
{
	...
	{
		speciesMap.get("Bulbasaur").setWeight(6.9);
		speciesMap.get("Ivysaur").setWeight(13.0);
		speciesMap.get("Venusaur").setWeight(100.0);
		speciesMap.get("Mega Venusaur").setWeight(155.5);
		speciesMap.get("Charmander").setWeight(8.5);
		speciesMap.get("Charmeleon").setWeight(19.0);
		speciesMap.get("Charizard").setWeight(90.5);
		speciesMap.get("Mega Charizard X").setWeight(110.5);
		speciesMap.get("Mega Charizard Y").setWeight(100.5);
		speciesMap.get("Squirtle").setWeight(9.0);
		speciesMap.get("Wartortle").setWeight(22.5);
		speciesMap.get("Blastoise").setWeight(85.5);
		speciesMap.get("Mega Blastoise").setWeight(101.1);
		speciesMap.get("Caterpie").setWeight(2.9);
		speciesMap.get("Metapod").setWeight(9.9);
		speciesMap.get("Butterfree").setWeight(32.0);
		speciesMap.get("Weedle").setWeight(3.2);
		speciesMap.get("Kakuna").setWeight(10.0);
		speciesMap.get("Beedrill").setWeight(29.5);
		speciesMap.get("Mega Beedrill").setWeight(40.5);
		speciesMap.get("Pidgey").setWeight(1.8);
		speciesMap.get("Pidgeotto").setWeight(30.0);
		speciesMap.get("Pidgeot").setWeight(39.5);
		speciesMap.get("Mega Pidgeot").setWeight(50.5);
		speciesMap.get("Rattata").setWeight(3.5);
		speciesMap.get("Raticate").setWeight(18.5);
		speciesMap.get("Spearow").setWeight(2.0);
		speciesMap.get("Fearow").setWeight(38.0);
		speciesMap.get("Ekans").setWeight(6.9);
		speciesMap.get("Arbok").setWeight(65.0);
		speciesMap.get("Pikachu").setWeight(6.0);
		speciesMap.get("Cosplay Pikachu").setWeight(6.0);
		speciesMap.get("Pikachu Rock Star").setWeight(6.0);
		speciesMap.get("Pikachu Belle").setWeight(6.0);
		speciesMap.get("Pikachu Pop Star").setWeight(6.0);
		speciesMap.get("Pikachu, Ph.D.").setWeight(6.0);
		speciesMap.get("Pikachu Libre").setWeight(6.0);
		speciesMap.get("Raichu").setWeight(30.0);
		speciesMap.get("Sandshrew").setWeight(12.0);
		speciesMap.get("Sandslash").setWeight(29.5);
		speciesMap.get("Nidoran").setWeight(7.0);
		speciesMap.get("Nidorina").setWeight(20.0);
		speciesMap.get("Nidoqueen").setWeight(60.0);
		speciesMap.get("Nidoran").setWeight(9.0);
		speciesMap.get("Nidorino").setWeight(19.5);
		speciesMap.get("Nidoking").setWeight(62.0);
		speciesMap.get("Clefairy").setWeight(7.5);
		speciesMap.get("Clefable").setWeight(40.0);
		speciesMap.get("Vulpix").setWeight(9.9);
		speciesMap.get("Ninetales").setWeight(19.9);
		speciesMap.get("Jigglypuff").setWeight(5.5);
		speciesMap.get("Wigglytuff").setWeight(12.0);
		speciesMap.get("Zubat").setWeight(7.5);
		speciesMap.get("Golbat").setWeight(55.0);
		speciesMap.get("Oddish").setWeight(5.4);
		speciesMap.get("Gloom").setWeight(8.6);
		speciesMap.get("Vileplume").setWeight(18.6);
		speciesMap.get("Paras").setWeight(5.4);
		speciesMap.get("Parasect").setWeight(29.5);
		speciesMap.get("Venonat").setWeight(30.0);
		speciesMap.get("Venomoth").setWeight(12.5);
		speciesMap.get("Diglett").setWeight(0.8);
		speciesMap.get("Dugtrio").setWeight(33.3);
		speciesMap.get("Meowth").setWeight(4.2);
		speciesMap.get("Persian").setWeight(32.0);
		speciesMap.get("Psyduck").setWeight(19.6);
		speciesMap.get("Golduck").setWeight(76.6);
		speciesMap.get("Mankey").setWeight(28.0);
		speciesMap.get("Primeape").setWeight(32.0);
		speciesMap.get("Growlithe").setWeight(19.0);
		speciesMap.get("Arcanine").setWeight(155.0);
		speciesMap.get("Poliwag").setWeight(12.4);
		speciesMap.get("Poliwhirl").setWeight(20.0);
		speciesMap.get("Poliwrath").setWeight(54.0);
		speciesMap.get("Abra").setWeight(19.5);
		speciesMap.get("Kadabra").setWeight(56.5);
		speciesMap.get("Alakazam").setWeight(48.0);
		speciesMap.get("Mega Alakazam").setWeight(48.0);
		speciesMap.get("Machop").setWeight(19.5);
		speciesMap.get("Machoke").setWeight(70.5);
		speciesMap.get("Machamp").setWeight(130.0);
		speciesMap.get("Bellsprout").setWeight(4.0);
		speciesMap.get("Weepinbell").setWeight(6.4);
		speciesMap.get("Victreebel").setWeight(15.5);
		speciesMap.get("Tentacool").setWeight(45.5);
		speciesMap.get("Tentacruel").setWeight(55.0);
		speciesMap.get("Geodude").setWeight(20.0);
		speciesMap.get("Graveler").setWeight(105.0);
		speciesMap.get("Golem").setWeight(300.0);
		speciesMap.get("Ponyta").setWeight(30.0);
		speciesMap.get("Rapidash").setWeight(95.0);
		speciesMap.get("Slowpoke").setWeight(36.0);
		speciesMap.get("Slowbro").setWeight(78.5);
		speciesMap.get("Mega Slowbro").setWeight(120.0);
		speciesMap.get("Magnemite").setWeight(6.0);
		speciesMap.get("Magneton").setWeight(60.0);
		speciesMap.get("Farfetch'd").setWeight(15.0);
		speciesMap.get("Doduo").setWeight(39.2);
		speciesMap.get("Dodrio").setWeight(85.2);
		speciesMap.get("Seel").setWeight(90.0);
		speciesMap.get("Dewgong").setWeight(120.0);
		speciesMap.get("Grimer").setWeight(30.0);
		speciesMap.get("Muk").setWeight(30.0);
		speciesMap.get("Shellder").setWeight(4.0);
		speciesMap.get("Cloyster").setWeight(132.5);
		speciesMap.get("Gastly").setWeight(0.1);
		speciesMap.get("Haunter").setWeight(0.1);
		speciesMap.get("Gengar").setWeight(40.5);
		speciesMap.get("Mega Gengar").setWeight(40.5);
		speciesMap.get("Onix").setWeight(210.0);
		speciesMap.get("Drowzee").setWeight(32.4);
		speciesMap.get("Hypno").setWeight(75.6);
		speciesMap.get("Krabby").setWeight(6.5);
		speciesMap.get("Kingler").setWeight(60.0);
		speciesMap.get("Voltorb").setWeight(10.4);
		speciesMap.get("Electrode").setWeight(66.6);
		speciesMap.get("Exeggcute").setWeight(2.5);
		speciesMap.get("Exeggutor").setWeight(120.0);
		speciesMap.get("Cubone").setWeight(6.5);
		speciesMap.get("Marowak").setWeight(45.0);
		speciesMap.get("Hitmonlee").setWeight(49.8);
		speciesMap.get("Hitmonchan").setWeight(50.2);
		speciesMap.get("Lickitung").setWeight(65.5);
		speciesMap.get("Koffing").setWeight(1.0);
		speciesMap.get("Weezing").setWeight(9.5);
		speciesMap.get("Rhyhorn").setWeight(115.0);
		speciesMap.get("Rhydon").setWeight(120.0);
		speciesMap.get("Chansey").setWeight(34.6);
		speciesMap.get("Tangela").setWeight(35.0);
		speciesMap.get("Kangaskhan").setWeight(80.0);
		speciesMap.get("Mega Kangaskhan").setWeight(100.0);
		speciesMap.get("Horsea").setWeight(8.0);
		speciesMap.get("Seadra").setWeight(25.0);
		speciesMap.get("Goldeen").setWeight(15.0);
		speciesMap.get("Seaking").setWeight(39.0);
		speciesMap.get("Staryu").setWeight(34.5);
		speciesMap.get("Starmie").setWeight(80.0);
		speciesMap.get("Mr. Mime").setWeight(54.5);
		speciesMap.get("Scyther").setWeight(56.0);
		speciesMap.get("Jynx").setWeight(40.6);
		speciesMap.get("Electabuzz").setWeight(30.0);
		speciesMap.get("Magmar").setWeight(44.5);
		speciesMap.get("Pinsir").setWeight(55.0);
		speciesMap.get("Mega Pinsir").setWeight(59.0);
		speciesMap.get("Tauros").setWeight(88.4);
		speciesMap.get("Magikarp").setWeight(10.0);
		speciesMap.get("Gyarados").setWeight(235.0);
		speciesMap.get("Mega Gyarados").setWeight(305.0);
		speciesMap.get("Lapras").setWeight(220.0);
		speciesMap.get("Ditto").setWeight(4.0);
		speciesMap.get("Eevee").setWeight(6.5);
		speciesMap.get("Vaporeon").setWeight(29.0);
		speciesMap.get("Jolteon").setWeight(24.5);
		speciesMap.get("Flareon").setWeight(25.0);
		speciesMap.get("Porygon").setWeight(36.5);
		speciesMap.get("Omanyte").setWeight(7.5);
		speciesMap.get("Omastar").setWeight(35.0);
		speciesMap.get("Kabuto").setWeight(11.5);
		speciesMap.get("Kabutops").setWeight(40.5);
		speciesMap.get("Aerodactyl").setWeight(59.0);
		speciesMap.get("Mega Aerodactyl").setWeight(79.0);
		speciesMap.get("Snorlax").setWeight(460.0);
		speciesMap.get("Articuno").setWeight(55.4);
		speciesMap.get("Zapdos").setWeight(52.6);
		speciesMap.get("Moltres").setWeight(60.0);
		speciesMap.get("Dratini").setWeight(3.3);
		speciesMap.get("Dragonair").setWeight(16.5);
		speciesMap.get("Dragonite").setWeight(210.0);
		speciesMap.get("Mewtwo").setWeight(122.0);
		speciesMap.get("Mega Mewtwo X").setWeight(127.0);
		speciesMap.get("Mega Mewtwo Y").setWeight(33.0);
		speciesMap.get("Mew").setWeight(4.0);
		speciesMap.get("Chikorita").setWeight(6.4);
		speciesMap.get("Bayleef").setWeight(15.8);
		speciesMap.get("Meganium").setWeight(100.5);
		speciesMap.get("Cyndaquil").setWeight(7.9);
		speciesMap.get("Quilava").setWeight(19.0);
		speciesMap.get("Typhlosion").setWeight(79.5);
		speciesMap.get("Totodile").setWeight(9.5);
		speciesMap.get("Croconaw").setWeight(25.0);
		speciesMap.get("Feraligatr").setWeight(88.8);
		speciesMap.get("Sentret").setWeight(6.0);
		speciesMap.get("Furret").setWeight(32.5);
		speciesMap.get("Hoothoot").setWeight(21.2);
		speciesMap.get("Noctowl").setWeight(40.8);
		speciesMap.get("Ledyba").setWeight(10.8);
		speciesMap.get("Ledian").setWeight(35.6);
		speciesMap.get("Spinarak").setWeight(8.5);
		speciesMap.get("Ariados").setWeight(33.5);
		speciesMap.get("Crobat").setWeight(75.0);
		speciesMap.get("Chinchou").setWeight(12.0);
		speciesMap.get("Lanturn").setWeight(22.5);
		speciesMap.get("Pichu").setWeight(2.0);
		speciesMap.get("Cleffa").setWeight(3.0);
		speciesMap.get("Igglybuff").setWeight(1.0);
		speciesMap.get("Togepi").setWeight(1.5);
		speciesMap.get("Togetic").setWeight(3.2);
		speciesMap.get("Natu").setWeight(2.0);
		speciesMap.get("Xatu").setWeight(15.0);
		speciesMap.get("Mareep").setWeight(7.8);
		speciesMap.get("Flaaffy").setWeight(13.3);
		speciesMap.get("Ampharos").setWeight(61.5);
		speciesMap.get("Mega Ampharos").setWeight(61.5);
		speciesMap.get("Bellossom").setWeight(5.8);
		speciesMap.get("Marill").setWeight(8.5);
		speciesMap.get("Azumarill").setWeight(28.5);
		speciesMap.get("Sudowoodo").setWeight(38.0);
		speciesMap.get("Politoed").setWeight(33.9);
		speciesMap.get("Hoppip").setWeight(0.5);
		speciesMap.get("Skiploom").setWeight(1.0);
		speciesMap.get("Jumpluff").setWeight(3.0);
		speciesMap.get("Aipom").setWeight(11.5);
		speciesMap.get("Sunkern").setWeight(1.8);
		speciesMap.get("Sunflora").setWeight(8.5);
		speciesMap.get("Yanma").setWeight(38.0);
		speciesMap.get("Wooper").setWeight(8.5);
		speciesMap.get("Quagsire").setWeight(75.0);
		speciesMap.get("Espeon").setWeight(26.5);
		speciesMap.get("Umbreon").setWeight(27.0);
		speciesMap.get("Murkrow").setWeight(2.1);
		speciesMap.get("Slowking").setWeight(79.5);
		speciesMap.get("Misdreavus").setWeight(1.0);
		speciesMap.get("Unown").setWeight(5.0);
		speciesMap.get("Wobbuffet").setWeight(28.5);
		speciesMap.get("Girafarig").setWeight(41.5);
		speciesMap.get("Pineco").setWeight(7.2);
		speciesMap.get("Forretress").setWeight(125.8);
		speciesMap.get("Dunsparce").setWeight(14.0);
		speciesMap.get("Gligar").setWeight(64.8);
		speciesMap.get("Steelix").setWeight(400.0);
		speciesMap.get("Mega Steelix").setWeight(740.0);
		speciesMap.get("Snubbull").setWeight(7.8);
		speciesMap.get("Granbull").setWeight(48.7);
		speciesMap.get("Qwilfish").setWeight(3.9);
		speciesMap.get("Scizor").setWeight(118.0);
		speciesMap.get("Mega Scizor").setWeight(125.0);
		speciesMap.get("Shuckle").setWeight(20.5);
		speciesMap.get("Heracross").setWeight(54.0);
		speciesMap.get("Mega Heracross").setWeight(62.5);
		speciesMap.get("Sneasel").setWeight(28.0);
		speciesMap.get("Teddiursa").setWeight(8.8);
		speciesMap.get("Ursaring").setWeight(125.8);
		speciesMap.get("Slugma").setWeight(35.0);
		speciesMap.get("Magcargo").setWeight(55.0);
		speciesMap.get("Swinub").setWeight(6.5);
		speciesMap.get("Piloswine").setWeight(55.8);
		speciesMap.get("Corsola").setWeight(5.0);
		speciesMap.get("Remoraid").setWeight(12.0);
		speciesMap.get("Octillery").setWeight(28.5);
		speciesMap.get("Delibird").setWeight(16.0);
		speciesMap.get("Mantine").setWeight(220.0);
		speciesMap.get("Skarmory").setWeight(50.5);
		speciesMap.get("Houndour").setWeight(10.8);
		speciesMap.get("Houndoom").setWeight(35.0);
		speciesMap.get("Mega Houndoom").setWeight(49.5);
		speciesMap.get("Kingdra").setWeight(152.0);
		speciesMap.get("Phanpy").setWeight(33.5);
		speciesMap.get("Donphan").setWeight(120.0);
		speciesMap.get("Porygon2").setWeight(32.5);
		speciesMap.get("Stantler").setWeight(71.2);
		speciesMap.get("Smeargle").setWeight(58.0);
		speciesMap.get("Tyrogue").setWeight(21.0);
		speciesMap.get("Hitmontop").setWeight(48.0);
		speciesMap.get("Smoochum").setWeight(6.0);
		speciesMap.get("Elekid").setWeight(23.5);
		speciesMap.get("Magby").setWeight(21.4);
		speciesMap.get("Miltank").setWeight(75.5);
		speciesMap.get("Blissey").setWeight(46.8);
		speciesMap.get("Raikou").setWeight(178.0);
		speciesMap.get("Entei").setWeight(198.0);
		speciesMap.get("Suicune").setWeight(187.0);
		speciesMap.get("Larvitar").setWeight(72.0);
		speciesMap.get("Pupitar").setWeight(152.0);
		speciesMap.get("Tyranitar").setWeight(202.0);
		speciesMap.get("Mega Tyranitar").setWeight(255.0);
		speciesMap.get("Lugia").setWeight(216.0);
		speciesMap.get("Ho-Oh").setWeight(199.0);
		speciesMap.get("Celebi").setWeight(5.0);
		speciesMap.get("Treecko").setWeight(5.0);
		speciesMap.get("Grovyle").setWeight(21.6);
		speciesMap.get("Sceptile").setWeight(52.2);
		speciesMap.get("Mega Sceptile").setWeight(55.2);
		speciesMap.get("Torchic").setWeight(2.5);
		speciesMap.get("Combusken").setWeight(19.5);
		speciesMap.get("Blaziken").setWeight(52.0);
		speciesMap.get("Mega Blaziken").setWeight(52.0);
		speciesMap.get("Mudkip").setWeight(7.6);
		speciesMap.get("Marshtomp").setWeight(28.0);
		speciesMap.get("Swampert").setWeight(81.9);
		speciesMap.get("Mega Swampert").setWeight(102.0);
		speciesMap.get("Poochyena").setWeight(13.6);
		speciesMap.get("Mightyena").setWeight(37.0);
		speciesMap.get("Zigzagoon").setWeight(17.5);
		speciesMap.get("Linoone").setWeight(32.5);
		speciesMap.get("Wurmple").setWeight(3.6);
		speciesMap.get("Silcoon").setWeight(10.0);
		speciesMap.get("Beautifly").setWeight(28.4);
		speciesMap.get("Cascoon").setWeight(11.5);
		speciesMap.get("Dustox").setWeight(31.6);
		speciesMap.get("Lotad").setWeight(2.6);
		speciesMap.get("Lombre").setWeight(32.5);
		speciesMap.get("Ludicolo").setWeight(55.0);
		speciesMap.get("Seedot").setWeight(4.0);
		speciesMap.get("Nuzleaf").setWeight(28.0);
		speciesMap.get("Shiftry").setWeight(59.6);
		speciesMap.get("Taillow").setWeight(2.3);
		speciesMap.get("Swellow").setWeight(19.8);
		speciesMap.get("Wingull").setWeight(9.5);
		speciesMap.get("Pelipper").setWeight(28.0);
		speciesMap.get("Ralts").setWeight(6.6);
		speciesMap.get("Kirlia").setWeight(20.2);
		speciesMap.get("Gardevoir").setWeight(48.4);
		speciesMap.get("Mega Gardevoir").setWeight(48.4);
		speciesMap.get("Surskit").setWeight(1.7);
		speciesMap.get("Masquerain").setWeight(3.6);
		speciesMap.get("Shroomish").setWeight(4.5);
		speciesMap.get("Breloom").setWeight(39.2);
		speciesMap.get("Slakoth").setWeight(24.0);
		speciesMap.get("Vigoroth").setWeight(46.5);
		speciesMap.get("Slaking").setWeight(130.5);
		speciesMap.get("Nincada").setWeight(5.5);
		speciesMap.get("Ninjask").setWeight(12.0);
		speciesMap.get("Shedinja").setWeight(1.2);
		speciesMap.get("Whismur").setWeight(16.3);
		speciesMap.get("Loudred").setWeight(40.5);
		speciesMap.get("Exploud").setWeight(84.0);
		speciesMap.get("Makuhita").setWeight(86.4);
		speciesMap.get("Hariyama").setWeight(253.8);
		speciesMap.get("Azurill").setWeight(2.0);
		speciesMap.get("Nosepass").setWeight(97.0);
		speciesMap.get("Skitty").setWeight(11.0);
		speciesMap.get("Delcatty").setWeight(32.6);
		speciesMap.get("Sableye").setWeight(11.0);
		speciesMap.get("Mega Sableye").setWeight(161.0);
		speciesMap.get("Mawile").setWeight(11.5);
		speciesMap.get("Mega Mawile").setWeight(23.5);
		speciesMap.get("Aron").setWeight(60.0);
		speciesMap.get("Lairon").setWeight(120.0);
		speciesMap.get("Aggron").setWeight(360.0);
		speciesMap.get("Mega Aggron").setWeight(395.0);
		speciesMap.get("Meditite").setWeight(11.2);
		speciesMap.get("Medicham").setWeight(31.5);
		speciesMap.get("Mega Medicham").setWeight(31.5);
		speciesMap.get("Electrike").setWeight(15.2);
		speciesMap.get("Manectric").setWeight(40.2);
		speciesMap.get("Mega Manectric").setWeight(44.0);
		speciesMap.get("Plusle").setWeight(4.2);
		speciesMap.get("Minun").setWeight(4.2);
		speciesMap.get("Volbeat").setWeight(17.7);
		speciesMap.get("Illumise").setWeight(17.7);
		speciesMap.get("Roselia").setWeight(2.0);
		speciesMap.get("Gulpin").setWeight(10.3);
		speciesMap.get("Swalot").setWeight(80.0);
		speciesMap.get("Carvanha").setWeight(20.8);
		speciesMap.get("Sharpedo").setWeight(88.8);
		speciesMap.get("Mega Sharpedo").setWeight(130.3);
		speciesMap.get("Wailmer").setWeight(130.0);
		speciesMap.get("Wailord").setWeight(398.0);
		speciesMap.get("Numel").setWeight(24.0);
		speciesMap.get("Camerupt").setWeight(220.0);
		speciesMap.get("Mega Camerupt").setWeight(320.5);
		speciesMap.get("Torkoal").setWeight(80.4);
		speciesMap.get("Spoink").setWeight(30.6);
		speciesMap.get("Grumpig").setWeight(71.5);
		speciesMap.get("Spinda").setWeight(5.0);
		speciesMap.get("Trapinch").setWeight(15.0);
		speciesMap.get("Vibrava").setWeight(15.3);
		speciesMap.get("Flygon").setWeight(82.0);
		speciesMap.get("Cacnea").setWeight(51.3);
		speciesMap.get("Cacturne").setWeight(77.4);
		speciesMap.get("Swablu").setWeight(1.2);
		speciesMap.get("Altaria").setWeight(20.6);
		speciesMap.get("Mega Altaria").setWeight(20.6);
		speciesMap.get("Zangoose").setWeight(40.3);
		speciesMap.get("Seviper").setWeight(52.5);
		speciesMap.get("Lunatone").setWeight(168.0);
		speciesMap.get("Solrock").setWeight(154.0);
		speciesMap.get("Barboach").setWeight(1.9);
		speciesMap.get("Whiscash").setWeight(23.6);
		speciesMap.get("Corphish").setWeight(11.5);
		speciesMap.get("Crawdaunt").setWeight(32.8);
		speciesMap.get("Baltoy").setWeight(21.5);
		speciesMap.get("Claydol").setWeight(108.0);
		speciesMap.get("Lileep").setWeight(23.8);
		speciesMap.get("Cradily").setWeight(60.4);
		speciesMap.get("Anorith").setWeight(12.5);
		speciesMap.get("Armaldo").setWeight(68.2);
		speciesMap.get("Feebas").setWeight(7.4);
		speciesMap.get("Milotic").setWeight(162.0);
		speciesMap.get("Castform").setWeight(0.8);
		speciesMap.get("Sunny Castform").setWeight(0.8);
		speciesMap.get("Rainy Castform").setWeight(0.8);
		speciesMap.get("Snowy Castform").setWeight(0.8);
		speciesMap.get("Kecleon").setWeight(22.0);
		speciesMap.get("Shuppet").setWeight(2.3);
		speciesMap.get("Banette").setWeight(12.5);
		speciesMap.get("Mega Banette").setWeight(13.0);
		speciesMap.get("Duskull").setWeight(15.0);
		speciesMap.get("Dusclops").setWeight(30.6);
		speciesMap.get("Tropius").setWeight(100.0);
		speciesMap.get("Chimecho").setWeight(1.0);
		speciesMap.get("Absol").setWeight(47.0);
		speciesMap.get("Mega Absol").setWeight(49.0);
		speciesMap.get("Wynaut").setWeight(14.0);
		speciesMap.get("Snorunt").setWeight(16.8);
		speciesMap.get("Glalie").setWeight(256.5);
		speciesMap.get("Mega Glalie").setWeight(350.2);
		speciesMap.get("Spheal").setWeight(39.5);
		speciesMap.get("Sealeo").setWeight(87.6);
		speciesMap.get("Walrein").setWeight(150.6);
		speciesMap.get("Clamperl").setWeight(52.5);
		speciesMap.get("Huntail").setWeight(27.0);
		speciesMap.get("Gorebyss").setWeight(22.6);
		speciesMap.get("Relicanth").setWeight(23.4);
		speciesMap.get("Luvdisc").setWeight(8.7);
		speciesMap.get("Bagon").setWeight(42.1);
		speciesMap.get("Shelgon").setWeight(110.5);
		speciesMap.get("Salamence").setWeight(102.6);
		speciesMap.get("Mega Salamence").setWeight(112.6);
		speciesMap.get("Beldum").setWeight(95.2);
		speciesMap.get("Metang").setWeight(202.5);
		speciesMap.get("Metagross").setWeight(550.0);
		speciesMap.get("Mega Metagross").setWeight(942.9);
		speciesMap.get("Regirock").setWeight(230.0);
		speciesMap.get("Regice").setWeight(175.0);
		speciesMap.get("Registeel").setWeight(205.0);
		speciesMap.get("Latias").setWeight(40.0);
		speciesMap.get("Mega Latias").setWeight(52.0);
		speciesMap.get("Latios").setWeight(60.0);
		speciesMap.get("Mega Latios").setWeight(70.0);
		speciesMap.get("Kyogre").setWeight(352.0);
		speciesMap.get("Primal Kyogre").setWeight(430.0);
		speciesMap.get("Groudon").setWeight(950.0);
		speciesMap.get("Primal Groudon").setWeight(999.7);
		speciesMap.get("Rayquaza").setWeight(206.5);
		speciesMap.get("Mega Rayquaza").setWeight(392.0);
		speciesMap.get("Jirachi").setWeight(1.1);
		speciesMap.get("Normal Deoxys").setWeight(60.8);
		speciesMap.get("Attack Deoxys").setWeight(60.8);
		speciesMap.get("Defense Deoxys").setWeight(60.8);
		speciesMap.get("Speed Deoxys").setWeight(60.8);
		speciesMap.get("Turtwig").setWeight(10.2);
		speciesMap.get("Grotle").setWeight(97.0);
		speciesMap.get("Torterra").setWeight(310.0);
		speciesMap.get("Chimchar").setWeight(6.2);
		speciesMap.get("Monferno").setWeight(22.0);
		speciesMap.get("Infernape").setWeight(55.0);
		speciesMap.get("Piplup").setWeight(5.2);
		speciesMap.get("Prinplup").setWeight(23.0);
		speciesMap.get("Empoleon").setWeight(84.5);
		speciesMap.get("Starly").setWeight(2.0);
		speciesMap.get("Staravia").setWeight(15.5);
		speciesMap.get("Staraptor").setWeight(24.9);
		speciesMap.get("Bidoof").setWeight(20.0);
		speciesMap.get("Bibarel").setWeight(31.5);
		speciesMap.get("Kricketot").setWeight(2.2);
		speciesMap.get("Kricketune").setWeight(25.5);
		speciesMap.get("Shinx").setWeight(9.5);
		speciesMap.get("Luxio").setWeight(30.5);
		speciesMap.get("Luxray").setWeight(42.0);
		speciesMap.get("Budew").setWeight(1.2);
		speciesMap.get("Roserade").setWeight(14.5);
		speciesMap.get("Cranidos").setWeight(31.5);
		speciesMap.get("Rampardos").setWeight(102.5);
		speciesMap.get("Shieldon").setWeight(57.0);
		speciesMap.get("Bastiodon").setWeight(149.5);
		speciesMap.get("Burmy").setWeight(3.4);
		speciesMap.get("Plant Wormadam").setWeight(6.5);
		speciesMap.get("Sandy Wormadam").setWeight(6.5);
		speciesMap.get("Trash Wormadam").setWeight(6.5);
		speciesMap.get("Mothim").setWeight(23.3);
		speciesMap.get("Combee").setWeight(5.5);
		speciesMap.get("Vespiquen").setWeight(38.5);
		speciesMap.get("Pachirisu").setWeight(3.9);
		speciesMap.get("Buizel").setWeight(29.5);
		speciesMap.get("Floatzel").setWeight(33.5);
		speciesMap.get("Cherubi").setWeight(3.3);
		speciesMap.get("Cherrim").setWeight(9.3);
		speciesMap.get("Shellos").setWeight(6.3);
		speciesMap.get("Gastrodon").setWeight(29.9);
		speciesMap.get("Ambipom").setWeight(20.3);
		speciesMap.get("Drifloon").setWeight(1.2);
		speciesMap.get("Drifblim").setWeight(15.0);
		speciesMap.get("Buneary").setWeight(5.5);
		speciesMap.get("Lopunny").setWeight(33.3);
		speciesMap.get("Mega Lopunny").setWeight(28.3);
		speciesMap.get("Mismagius").setWeight(4.4);
		speciesMap.get("Honchkrow").setWeight(27.3);
		speciesMap.get("Glameow").setWeight(3.9);
		speciesMap.get("Purugly").setWeight(43.8);
		speciesMap.get("Chingling").setWeight(0.6);
		speciesMap.get("Stunky").setWeight(19.2);
		speciesMap.get("Skuntank").setWeight(38.0);
		speciesMap.get("Bronzor").setWeight(60.5);
		speciesMap.get("Bronzong").setWeight(187.0);
		speciesMap.get("Bonsly").setWeight(15.0);
		speciesMap.get("Mime Jr.").setWeight(13.0);
		speciesMap.get("Happiny").setWeight(24.4);
		speciesMap.get("Chatot").setWeight(1.9);
		speciesMap.get("Spiritomb").setWeight(108.0);
		speciesMap.get("Gible").setWeight(20.5);
		speciesMap.get("Gabite").setWeight(56.0);
		speciesMap.get("Garchomp").setWeight(95.0);
		speciesMap.get("Mega Garchomp").setWeight(95.0);
		speciesMap.get("Munchlax").setWeight(105.0);
		speciesMap.get("Riolu").setWeight(20.2);
		speciesMap.get("Lucario").setWeight(54.0);
		speciesMap.get("Mega Lucario").setWeight(57.5);
		speciesMap.get("Hippopotas").setWeight(49.5);
		speciesMap.get("Hippowdon").setWeight(300.0);
		speciesMap.get("Skorupi").setWeight(12.0);
		speciesMap.get("Drapion").setWeight(61.5);
		speciesMap.get("Croagunk").setWeight(23.0);
		speciesMap.get("Toxicroak").setWeight(44.4);
		speciesMap.get("Carnivine").setWeight(27.0);
		speciesMap.get("Finneon").setWeight(7.0);
		speciesMap.get("Lumineon").setWeight(24.0);
		speciesMap.get("Mantyke").setWeight(65.0);
		speciesMap.get("Snover").setWeight(50.5);
		speciesMap.get("Abomasnow").setWeight(135.5);
		speciesMap.get("Mega Abomasnow").setWeight(185.0);
		speciesMap.get("Weavile").setWeight(34.0);
		speciesMap.get("Magnezone").setWeight(180.0);
		speciesMap.get("Lickilicky").setWeight(140.0);
		speciesMap.get("Rhyperior").setWeight(282.8);
		speciesMap.get("Tangrowth").setWeight(128.6);
		speciesMap.get("Electivire").setWeight(138.6);
		speciesMap.get("Magmortar").setWeight(68.0);
		speciesMap.get("Togekiss").setWeight(38.0);
		speciesMap.get("Yanmega").setWeight(51.5);
		speciesMap.get("Leafeon").setWeight(25.5);
		speciesMap.get("Glaceon").setWeight(25.9);
		speciesMap.get("Gliscor").setWeight(42.5);
		speciesMap.get("Mamoswine").setWeight(291.0);
		speciesMap.get("Porygon-Z").setWeight(34.0);
		speciesMap.get("Gallade").setWeight(52.0);
		speciesMap.get("Mega Gallade").setWeight(56.4);
		speciesMap.get("Probopass").setWeight(340.0);
		speciesMap.get("Dusknoir").setWeight(106.6);
		speciesMap.get("Froslass").setWeight(26.6);
		speciesMap.get("Rotom").setWeight(0.3);
		speciesMap.get("Heat Rotom").setWeight(0.3);
		speciesMap.get("Wash Rotom").setWeight(0.3);
		speciesMap.get("Frost Rotom").setWeight(0.3);
		speciesMap.get("Fan Rotom").setWeight(0.3);
		speciesMap.get("Mow Rotom").setWeight(0.3);
		speciesMap.get("Uxie").setWeight(0.3);
		speciesMap.get("Mesprit").setWeight(0.3);
		speciesMap.get("Azelf").setWeight(0.3);
		speciesMap.get("Dialga").setWeight(683.0);
		speciesMap.get("Palkia").setWeight(336.0);
		speciesMap.get("Heatran").setWeight(430.0);
		speciesMap.get("Regigigas").setWeight(420.0);
		speciesMap.get("Altered Giratina").setWeight(750.0);
		speciesMap.get("Origin Giratina").setWeight(650.0);
		speciesMap.get("Cresselia").setWeight(85.6);
		speciesMap.get("Phione").setWeight(3.1);
		speciesMap.get("Manaphy").setWeight(1.4);
		speciesMap.get("Darkrai").setWeight(50.5);
		speciesMap.get("Land Shaymin").setWeight(2.1);
		speciesMap.get("Sky Shaymin").setWeight(5.2);
		speciesMap.get("Arceus").setWeight(320.0);
		speciesMap.get("Victini").setWeight(4.0);
		speciesMap.get("Snivy").setWeight(8.1);
		speciesMap.get("Servine").setWeight(16.0);
		speciesMap.get("Serperior").setWeight(63.0);
		speciesMap.get("Tepig").setWeight(9.9);
		speciesMap.get("Pignite").setWeight(55.5);
		speciesMap.get("Emboar").setWeight(150.0);
		speciesMap.get("Oshawott").setWeight(5.9);
		speciesMap.get("Dewott").setWeight(24.5);
		speciesMap.get("Samurott").setWeight(94.6);
		speciesMap.get("Patrat").setWeight(11.6);
		speciesMap.get("Watchog").setWeight(27.0);
		speciesMap.get("Lillipup").setWeight(4.1);
		speciesMap.get("Herdier").setWeight(14.7);
		speciesMap.get("Stoutland").setWeight(61.0);
		speciesMap.get("Purrloin").setWeight(10.1);
		speciesMap.get("Liepard").setWeight(37.5);
		speciesMap.get("Pansage").setWeight(10.5);
		speciesMap.get("Simisage").setWeight(30.5);
		speciesMap.get("Pansear").setWeight(11.0);
		speciesMap.get("Simisear").setWeight(28.0);
		speciesMap.get("Panpour").setWeight(13.5);
		speciesMap.get("Simipour").setWeight(29.0);
		speciesMap.get("Munna").setWeight(23.3);
		speciesMap.get("Musharna").setWeight(60.5);
		speciesMap.get("Pidove").setWeight(2.1);
		speciesMap.get("Tranquill").setWeight(15.0);
		speciesMap.get("Unfezant").setWeight(29.0);
		speciesMap.get("Blitzle").setWeight(29.8);
		speciesMap.get("Zebstrika").setWeight(79.5);
		speciesMap.get("Roggenrola").setWeight(18.0);
		speciesMap.get("Boldore").setWeight(102.0);
		speciesMap.get("Gigalith").setWeight(260.0);
		speciesMap.get("Woobat").setWeight(2.1);
		speciesMap.get("Swoobat").setWeight(10.5);
		speciesMap.get("Drilbur").setWeight(8.5);
		speciesMap.get("Excadrill").setWeight(40.4);
		speciesMap.get("Audino").setWeight(31.0);
		speciesMap.get("Mega Audino").setWeight(32.0);
		speciesMap.get("Timburr").setWeight(12.5);
		speciesMap.get("Gurdurr").setWeight(40.0);
		speciesMap.get("Conkeldurr").setWeight(87.0);
		speciesMap.get("Tympole").setWeight(4.5);
		speciesMap.get("Palpitoad").setWeight(17.0);
		speciesMap.get("Seismitoad").setWeight(62.0);
		speciesMap.get("Throh").setWeight(55.5);
		speciesMap.get("Sawk").setWeight(51.0);
		speciesMap.get("Sewaddle").setWeight(2.5);
		speciesMap.get("Swadloon").setWeight(7.3);
		speciesMap.get("Leavanny").setWeight(20.5);
		speciesMap.get("Venipede").setWeight(5.3);
		speciesMap.get("Whirlipede").setWeight(58.5);
		speciesMap.get("Scolipede").setWeight(200.5);
		speciesMap.get("Cottonee").setWeight(0.6);
		speciesMap.get("Whimsicott").setWeight(6.6);
		speciesMap.get("Petilil").setWeight(6.6);
		speciesMap.get("Lilligant").setWeight(16.3);
		speciesMap.get("Red-Striped Basculin").setWeight(18.0);
		speciesMap.get("Blue-Striped Basculin").setWeight(18.0);
		speciesMap.get("Sandile").setWeight(15.2);
		speciesMap.get("Krokorok").setWeight(33.4);
		speciesMap.get("Krookodile").setWeight(96.3);
		speciesMap.get("Darumaka").setWeight(37.5);
		speciesMap.get("Standard Darmanitan").setWeight(92.9);
		speciesMap.get("Zen Darmanitan").setWeight(92.9);
		speciesMap.get("Maractus").setWeight(28.0);
		speciesMap.get("Dwebble").setWeight(14.5);
		speciesMap.get("Crustle").setWeight(200.0);
		speciesMap.get("Scraggy").setWeight(11.8);
		speciesMap.get("Scrafty").setWeight(30.0);
		speciesMap.get("Sigilyph").setWeight(14.0);
		speciesMap.get("Yamask").setWeight(1.5);
		speciesMap.get("Cofagrigus").setWeight(76.5);
		speciesMap.get("Tirtouga").setWeight(16.5);
		speciesMap.get("Carracosta").setWeight(81.0);
		speciesMap.get("Archen").setWeight(9.5);
		speciesMap.get("Archeops").setWeight(32.0);
		speciesMap.get("Trubbish").setWeight(31.0);
		speciesMap.get("Garbodor").setWeight(107.3);
		speciesMap.get("Zorua").setWeight(12.5);
		speciesMap.get("Zoroark").setWeight(81.1);
		speciesMap.get("Minccino").setWeight(5.8);
		speciesMap.get("Cinccino").setWeight(7.5);
		speciesMap.get("Gothita").setWeight(5.8);
		speciesMap.get("Gothorita").setWeight(18.0);
		speciesMap.get("Gothitelle").setWeight(44.0);
		speciesMap.get("Solosis").setWeight(1.0);
		speciesMap.get("Duosion").setWeight(8.0);
		speciesMap.get("Reuniclus").setWeight(20.1);
		speciesMap.get("Ducklett").setWeight(5.5);
		speciesMap.get("Swanna").setWeight(24.2);
		speciesMap.get("Vanillite").setWeight(5.7);
		speciesMap.get("Vanillish").setWeight(41.0);
		speciesMap.get("Vanilluxe").setWeight(57.5);
		speciesMap.get("Deerling").setWeight(19.5);
		speciesMap.get("Sawsbuck").setWeight(92.5);
		speciesMap.get("Emolga").setWeight(5.0);
		speciesMap.get("Karrablast").setWeight(5.9);
		speciesMap.get("Escavalier").setWeight(33.0);
		speciesMap.get("Foongus").setWeight(1.0);
		speciesMap.get("Amoonguss").setWeight(10.5);
		speciesMap.get("Frillish").setWeight(33.0);
		speciesMap.get("Jellicent").setWeight(135.0);
		speciesMap.get("Alomomola").setWeight(31.6);
		speciesMap.get("Joltik").setWeight(0.6);
		speciesMap.get("Galvantula").setWeight(14.3);
		speciesMap.get("Ferroseed").setWeight(18.8);
		speciesMap.get("Ferrothorn").setWeight(110.0);
		speciesMap.get("Klink").setWeight(21.0);
		speciesMap.get("Klang").setWeight(51.0);
		speciesMap.get("Klinklang").setWeight(81.0);
		speciesMap.get("Tynamo").setWeight(0.3);
		speciesMap.get("Eelektrik").setWeight(22.0);
		speciesMap.get("Eelektross").setWeight(80.5);
		speciesMap.get("Elgyem").setWeight(9.0);
		speciesMap.get("Beheeyem").setWeight(34.5);
		speciesMap.get("Litwick").setWeight(3.1);
		speciesMap.get("Lampent").setWeight(13.0);
		speciesMap.get("Chandelure").setWeight(34.3);
		speciesMap.get("Axew").setWeight(18.0);
		speciesMap.get("Fraxure").setWeight(36.0);
		speciesMap.get("Haxorus").setWeight(105.5);
		speciesMap.get("Cubchoo").setWeight(8.5);
		speciesMap.get("Beartic").setWeight(260.0);
		speciesMap.get("Cryogonal").setWeight(148.0);
		speciesMap.get("Shelmet").setWeight(7.7);
		speciesMap.get("Accelgor").setWeight(25.3);
		speciesMap.get("Stunfisk").setWeight(11.0);
		speciesMap.get("Mienfoo").setWeight(20.0);
		speciesMap.get("Mienshao").setWeight(35.5);
		speciesMap.get("Druddigon").setWeight(139.0);
		speciesMap.get("Golett").setWeight(92.0);
		speciesMap.get("Golurk").setWeight(330.0);
		speciesMap.get("Pawniard").setWeight(10.2);
		speciesMap.get("Bisharp").setWeight(70.0);
		speciesMap.get("Bouffalant").setWeight(94.6);
		speciesMap.get("Rufflet").setWeight(10.5);
		speciesMap.get("Braviary").setWeight(41.0);
		speciesMap.get("Vullaby").setWeight(9.0);
		speciesMap.get("Mandibuzz").setWeight(39.5);
		speciesMap.get("Heatmor").setWeight(58.0);
		speciesMap.get("Durant").setWeight(33.0);
		speciesMap.get("Deino").setWeight(17.3);
		speciesMap.get("Zweilous").setWeight(50.0);
		speciesMap.get("Hydreigon").setWeight(160.0);
		speciesMap.get("Larvesta").setWeight(28.8);
		speciesMap.get("Volcarona").setWeight(46.0);
		speciesMap.get("Cobalion").setWeight(250.0);
		speciesMap.get("Terrakion").setWeight(260.0);
		speciesMap.get("Virizion").setWeight(200.0);
		speciesMap.get("Incarnate Tornadus").setWeight(63.0);
		speciesMap.get("Therian Tornadus").setWeight(63.0);
		speciesMap.get("Incarnate Thundurus").setWeight(61.0);
		speciesMap.get("Therian Thundurus").setWeight(61.0);
		speciesMap.get("Reshiram").setWeight(330.0);
		speciesMap.get("Zekrom").setWeight(345.0);
		speciesMap.get("Incarnate Landorus").setWeight(68.0);
		speciesMap.get("Therian Landorus").setWeight(68.0);
		speciesMap.get("Kyurem").setWeight(325.0);
		speciesMap.get("Black Kyurem").setWeight(325.0);
		speciesMap.get("White Kyurem").setWeight(325.0);
		speciesMap.get("Ordinary Keldeo").setWeight(48.5);
		speciesMap.get("Resolute Keldeo").setWeight(48.5);
		speciesMap.get("Aria Meloetta").setWeight(6.5);
		speciesMap.get("Pirouette Meloetta").setWeight(6.5);
		speciesMap.get("Genesect").setWeight(82.5);
		speciesMap.get("Chespin").setWeight(9.0);
		speciesMap.get("Quilladin").setWeight(29.0);
		speciesMap.get("Chesnaught").setWeight(90.0);
		speciesMap.get("Fennekin").setWeight(9.4);
		speciesMap.get("Braixen").setWeight(14.5);
		speciesMap.get("Delphox").setWeight(39.0);
		speciesMap.get("Froakie").setWeight(7.0);
		speciesMap.get("Frogadier").setWeight(10.9);
		speciesMap.get("Greninja").setWeight(40.0);
		speciesMap.get("Bunnelby").setWeight(5.0);
		speciesMap.get("Diggersby").setWeight(42.4);
		speciesMap.get("Fletchling").setWeight(1.7);
		speciesMap.get("Fletchinder").setWeight(16.0);
		speciesMap.get("Talonflame").setWeight(24.5);
		speciesMap.get("Scatterbug").setWeight(2.5);
		speciesMap.get("Spewpa").setWeight(8.4);
		speciesMap.get("Vivillon").setWeight(17.0);
		speciesMap.get("Litleo").setWeight(13.5);
		speciesMap.get("Pyroar").setWeight(81.5);
		speciesMap.get("FlabÃƒ ©bÃƒ ©").setWeight(0.1);
		speciesMap.get("Floette").setWeight(0.9);
		speciesMap.get("Eternal Floette").setWeight(0.9);
		speciesMap.get("Florges").setWeight(10.0);
		speciesMap.get("Skiddo").setWeight(31.0);
		speciesMap.get("Gogoat").setWeight(91.0);
		speciesMap.get("Pancham").setWeight(8.0);
		speciesMap.get("Pangoro").setWeight(136.0);
		speciesMap.get("Furfrou").setWeight(28.0);
		speciesMap.get("Espurr").setWeight(3.5);
		speciesMap.get("Male Meowstic").setWeight(8.5);
		speciesMap.get("Female Meowstic").setWeight(8.5);
		speciesMap.get("Honedge").setWeight(2.0);
		speciesMap.get("Doublade").setWeight(4.5);
		speciesMap.get("Shield Aegislash").setWeight(53.0);
		speciesMap.get("Blade Aegislash").setWeight(53.0);
		speciesMap.get("Spritzee").setWeight(0.5);
		speciesMap.get("Aromatisse").setWeight(15.5);
		speciesMap.get("Swirlix").setWeight(3.5);
		speciesMap.get("Slurpuff").setWeight(5.0);
		speciesMap.get("Inkay").setWeight(3.5);
		speciesMap.get("Malamar").setWeight(47.0);
		speciesMap.get("Binacle").setWeight(31.0);
		speciesMap.get("Barbaracle").setWeight(96.0);
		speciesMap.get("Skrelp").setWeight(7.3);
		speciesMap.get("Dragalge").setWeight(81.5);
		speciesMap.get("Clauncher").setWeight(8.3);
		speciesMap.get("Clawitzer").setWeight(35.3);
		speciesMap.get("Helioptile").setWeight(6.0);
		speciesMap.get("Heliolisk").setWeight(21.0);
		speciesMap.get("Tyrunt").setWeight(26.0);
		speciesMap.get("Tyrantrum").setWeight(270.0);
		speciesMap.get("Amaura").setWeight(25.2);
		speciesMap.get("Aurorus").setWeight(225.0);
		speciesMap.get("Sylveon").setWeight(23.5);
		speciesMap.get("Hawlucha").setWeight(21.5);
		speciesMap.get("Dedenne").setWeight(2.2);
		speciesMap.get("Carbink").setWeight(5.7);
		speciesMap.get("Goomy").setWeight(2.8);
		speciesMap.get("Sliggoo").setWeight(17.5);
		speciesMap.get("Goodra").setWeight(150.5);
		speciesMap.get("Klefki").setWeight(3.0);
		speciesMap.get("Phantump").setWeight(7.0);
		speciesMap.get("Trevenant").setWeight(71.0);
		speciesMap.get("Small Pumpkaboo").setWeight(3.5);
		speciesMap.get("Average Pumpkaboo").setWeight(5.0);
		speciesMap.get("Large Pumpkaboo").setWeight(7.5);
		speciesMap.get("Super Pumpkaboo").setWeight(15.0);
		speciesMap.get("Small Gourgeist").setWeight(9.5);
		speciesMap.get("Average Gourgeist").setWeight(12.5);
		speciesMap.get("Large Gourgeist").setWeight(14.0);
		speciesMap.get("Super Gourgeist").setWeight(39.0);
		speciesMap.get("Bergmite").setWeight(99.5);
		speciesMap.get("Avalugg").setWeight(505.0);
		speciesMap.get("Noibat").setWeight(8.0);
		speciesMap.get("Noivern").setWeight(85.0);
		speciesMap.get("Xerneas").setWeight(215.0);
		speciesMap.get("Yveltal").setWeight(203.0);
		speciesMap.get("Zygarde").setWeight(305.0);
		speciesMap.get("Diancie").setWeight(8.8);
		speciesMap.get("Mega Diancie").setWeight(27.8);
		speciesMap.get("Hoopa").setWeight(9.0);
		speciesMap.get("Hoopa Unbound").setWeight(490.0);
		speciesMap.get("Volcanion").setWeight(195.0);
	}
}
